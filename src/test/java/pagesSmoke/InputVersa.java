...
public class InputVersa {
	 ...
	 WebDriver driver;
		...
		public void udp_in1(String addr1, String port1) throws Exception
		{
		...
		public void two_prog_udp(String addr1, String port1, String inter,String prog_name1,String prog_name2) throws InterruptedException
		{
			udp1c.click();
			Thread.sleep(1000);
			udp_source1.clear();
