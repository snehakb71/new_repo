...
public class Datadriver extends FlexBaseClass {
	...
	public void RunningJob(String JobName, String DataType ) throws Exception
	{
	...
	public void writecsvFile() throws Exception{
		...
		File log = new File("C:\\Testing3.3\\Automation\\Lohith.csv");
	...
	
	{
	 ...
	 int i,j;
		...
		File excel = new File("C:\\Testing3.3\\Automation\\Datadriven\\JobStatus.xlsx");
