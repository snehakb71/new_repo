...
public class SmokeXport15UDPmulticast_RTP extends BaseClassXportSmokeTest {
	
	@Test
	public void smokeXport15UDPmulticast_RTP() throws Exception {
		...
		job.jobData("smokeXport15UDPmulticast_RTP", "xport");
