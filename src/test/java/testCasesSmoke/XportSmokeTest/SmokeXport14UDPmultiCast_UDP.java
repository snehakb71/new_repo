...
public class SmokeXport14UDPmultiCast_UDP extends BaseClassXportSmokeTest {
	
	@Test
	public void smokeXport14UDPmulticast_UDP() throws Exception{
		...
		job.jobData("smokeXport14UDPmulticast_UDP", "xport");
