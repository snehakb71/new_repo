...
public class SmkVrs33MltProScteInband extends BaseClassSmokeTest{
	
	@Test
	
	public void smkVrs33MltProScteInband() throws Exception
	{
		...
		input.job_name("smkVrs33MltProScteInband");
		...
		out.streamer_out();
		out.streamer_name("inbandscteMultiprof");
