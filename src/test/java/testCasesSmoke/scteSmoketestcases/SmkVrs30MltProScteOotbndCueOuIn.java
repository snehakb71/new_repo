...
public class SmkVrs30MltProScteOotbndCueOuIn extends BaseClassSmokeTest{
	
	@Test
	public void smkVrs30MltProScteOotbndCueOuIn() throws Exception
	{
		...
		input.job_name("SmkVrs30MltProScteOotbndCueOuIn");
		...
		out.streamer_out();
		out.streamer_name("multiproOutBand");
