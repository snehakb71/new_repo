...
public class C3SmokeVersa3CRtmpInRtpUnicast extends BaseClassSmokeTest {
	...
	public void smokeVersa3CRtmpInRtpUnicast() throws Exception
	{
		...
		out.udp_1_profile(output.cluster_name(), output.udp_outUnicast_serverIp(), "7100", output.Cbr_mode(), output.track_1_out(), output.track_2_out());
