...
public class SmokeVersa6CUdpPassthroughUdpunicast extends BaseClassSmokeTest{
	...
	public void smokeVersa6CUdpPassthroughUdpunicast() throws Exception
	{
		...
		out.udp_1_profile(output.cluster_name(), output.udp_outUnicast_serverIp(), "7300", output.rate_control(), output.track_1_out(), output.track_2_out());
		out.create_out();
