...
public class C2SmokeVersa3bRtpUnicastRtmpOut extends BaseClassSmokeTest{
	
	@Test
	public void smokeVersa3bRtpUnicastRtmpOut() throws Exception
	{
		...
		input.job_name("SmokeVersa3bRtpUnicastRtmpOut");
