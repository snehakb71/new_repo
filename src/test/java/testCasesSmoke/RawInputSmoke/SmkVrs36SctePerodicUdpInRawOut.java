...
public class SmkVrs36SctePerodicUdpInRawOut extends BaseClassSmokeTest{
	
	@Test

	public void smkVrs36SctePerodicUdpInRawOut() throws Exception {
		...
		inp.job_name("SmkVrs36SctePerodicUdpInRawOut");
