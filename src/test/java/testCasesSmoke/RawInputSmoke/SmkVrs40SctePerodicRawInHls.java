...
public class SmkVrs40SctePerodicRawInHls extends BaseClassSmokeTest{
	
	@Test

	public void smkVrs40SctePerodicRawInHls() throws Exception {
		...
		pro.profile_select(profile.profile_pal_224());
		pro.MetaTrcakScte(profile.metaTrack());
		pro.profile_next();
		Thread.sleep(500);
