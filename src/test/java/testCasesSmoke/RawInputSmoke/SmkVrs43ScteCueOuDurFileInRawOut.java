...
public class SmkVrs43ScteCueOuDurFileInRawOut extends BaseClassSmokeTest {

	@Test

	public void smkVrs43ScteCueOuDurFileInRawOut() throws Exception {
		...
		inp.job_name("SmkVrs43ScteCueOuDurFileInRawOut");
